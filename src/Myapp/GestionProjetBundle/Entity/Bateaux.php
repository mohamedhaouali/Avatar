...
class Bateaux
{
    ...
    /**
     * @var string
     * @Assert\NotBlank(message="entrer votre villededepart.", groups={"Registration", "Profile"})
     *
    ...
    /**
     * @var string
     *@Assert\NotBlank(message="entrer votre villearrive.", groups={"Registration", "Profile"})
